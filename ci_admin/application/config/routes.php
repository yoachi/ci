...
$route['admin/members/view'] = 'admin_members/view';
$route['admin/members/view/(:any)'] = 'admin_members/view/$1';
$route['admin/members/(:any)'] = 'admin_members/index/$1'; //$1 = page number


$route['admin/material'] = 'admin_materials/index';
$route['admin/material/add'] = 'admin_materials/add';
$route['admin/material/update'] = 'admin_materials/update';
$route['admin/material/update/(:any)'] = 'admin_materials/update/$1';
$route['admin/material/delete/(:any)'] = 'admin_materials/delete/$1';
$route['admin/material/view'] = 'admin_materials/view';
$route['admin/material/view/(:any)'] = 'admin_materials/view/$1';
$route['admin/material/(:any)'] = 'admin_materials/index/$1'; //$1 = page number
