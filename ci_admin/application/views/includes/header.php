	  ...
	  <div class="navbar-inner">
	    <div class="container">
	      ...
	      <ul class="nav">
	        ...
	        <li <?php if($this->uri->segment(2) == 'members'){echo 'class="active"';}?>>
	          <a href="<?php echo base_url(); ?>admin/members">사용자관리</a>
	        </li>
	        <li <?php if($this->uri->segment(2) == 'material'){echo 'class="active"';}?>>
	          <a href="<?php echo base_url(); ?>admin/material">자재관리</a>
	        </li>
	        <li class="dropdown">
