      ...
      ?>
        <fieldset>
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="" name="name" value="<?php echo $member[0]['name']; ?>" >
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="" name="email_addres" value="<?php echo $member[0]['email_addres']; ?>">
              <!--<span class="help-inline">Cost Price</span>-->
            </div>
          </div>
          <div class="control-group">
            ...
            <?php
                      ...
                      foreach ($menus as $row)
                      {
                            ...
                            for($i=0;$i<sizeof($menu_actions);$i++){
                              ...
                              echo "<input type='checkbox' id='' name='permission[]' value='$row[name]".$menu_actions[$i]['action']."' $checked>".$menu_actions[$i]['name'];
                            }
